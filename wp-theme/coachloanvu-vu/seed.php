...
if ($dv2) {
    clv_set($dv2, [
        ...
        'dv2_targets' => [
            ['target_title' => 'NGƯỜI CHUẨN BỊ KHỞI NGHIỆP F&B', 'target_description' => 'Bạn có <strong>đam mê nhưng chưa bắt đầu</strong>. Bạn muốn đi bài bản ngay từ đầu, có bản đồ rõ ràng để tiết kiệm thời gian, tiền bạc.'],
            ['target_title' => 'CHỦ QUÁN ĐANG VẬN HÀNH', 'target_description' => 'Bạn đã mở quán, nhưng đang <strong>loay hoay với doanh thu, chi phí và nhân sự</strong>. Bạn muốn tìm một cách vận hành bài bản để quán ổn định, lợi nhuận rõ ràng.'],
            ['target_title' => 'TỪNG THẤT BẠI & MUỐN LÀM LẠI', 'target_description' => 'Bạn đã <strong>từng đóng cửa một quán</strong> nhưng vẫn đam mê khởi nghiệp với một lộ trình có hệ thống, với sự đồng hành của một coach thực chiến.'],
            ['target_title' => 'NGƯỜI KHAO KHÁT TỰ DO', 'target_description' => 'Bạn muốn <strong>xây dựng một mô hình F&B có lợi nhuận bền vững</strong> để bạn vừa kinh doanh hiệu quả, vừa có một cuộc đời tự do.'],
        ],
        'dv2_benefits' => [
            ['benefit_letter' => 'M', 'benefit_title' => 'MONEY – LỢI NHUẬN',  'benefit_description' => 'Bạn học cách xây dựng một mô hình kinh doanh có lợi nhuận rõ ràng. Biết quản lý chi phí, định giá đúng, kiểm soát Prime Cost, và tạo ra dòng tiền ổn định.'],
            ['benefit_letter' => 'M', 'benefit_title' => 'MEANING – Ý NGHĨA',   'benefit_description' => 'Kinh doanh không chỉ là bán món ăn. Đó là hành trình bạn gửi gắm niềm đam mê, giá trị và dấu ấn cá nhân, để mỗi bữa ăn trở thành một trải nghiệm mang ý nghĩa.'],
            ['benefit_letter' => 'F', 'benefit_title' => 'FREEDOM – TỰ DO',    'benefit_description' => 'Không còn bị trói chặt 24/7 trong quán. Với kế hoạch, đội ngũ và quy trình rõ ràng, bạn có thể vừa vận hành kinh doanh, vừa tận hưởng tự do.'],
        ],
        'dv2_differentiators' => [
            ['diff_title' => 'Người đồng hành: Vũ Kiều Loan', 'diff_description' => 'Hơn 15 năm trong ngành F&B, gần 10 năm khởi nghiệp, hiện là chủ chuỗi nhà hàng Mỹ tại Hà Nội. ICF PCC Coach quốc tế, tác giả sách.'],
            ['diff_title' => 'Kiến thức thực chiến', 'diff_description' => 'Tất cả bài học đến từ chính mô hình mà Loan đã vận hành thành công. Không phải lý thuyết sách vở, mà là những công cụ, quy trình có thể áp dụng ngay.'],
            ['diff_title' => 'Cộng đồng đồng hành', 'diff_description' => 'Bạn sẽ được kết nối với các học viên khác trong lớp. Một cộng đồng đủ nhỏ để sâu sát, đủ đa dạng để học hỏi lẫn nhau.'],
        ],
        'dv2_compare_rows' => [
            ['row_label' => 'Nội dung', 'row_p2p' => 'Giới thiệu tổng quan lộ trình 5P', 'row_b2f' => 'Đào sâu từng P, xây dựng kế hoạch, set up SOP, chỉ số tài chính'],
            ['row_label' => 'Mục đích', 'row_p2p' => 'Biết mình có phù hợp kinh doanh nhà hàng không', 'row_b2f' => 'Lên chi tiết bản kế hoạch kinh doanh và vận hành tối ưu'],
        ],
        'dv2_modules' => [
            ['module_week' => 'Tuần 1',  'module_title' => 'Passion', 'module_description' => 'Vai trò chủ quán & Bản đồ đam mê'],
            ['module_week' => 'Tuần 2',  'module_title' => 'Plan',    'module_description' => 'Khởi điểm, lựa chọn mô hình, phát triển ý tưởng'],
            ['module_week' => 'Tuần 3',  'module_title' => 'Plan',    'module_description' => 'Kế hoạch tài chính & dự toán vốn'],
            ['module_week' => 'Tuần 4',  'module_title' => 'Product', 'module_description' => 'Thực đơn: xây dựng, định giá, thiết kế'],
            ['module_week' => 'Tuần 5',  'module_title' => 'Product', 'module_description' => 'Mặt bằng & Trải nghiệm khách hàng'],
            ['module_week' => 'Tuần 6',  'module_title' => 'People',  'module_description' => 'Vai trò chủ quán, phân tích năng lực & mục tiêu'],
            ['module_week' => 'Tuần 7',  'module_title' => 'People',  'module_description' => 'Kế hoạch nhân sự, JD & sơ đồ đội nhóm ban đầu'],
            ['module_week' => 'Tuần 8',  'module_title' => 'Process', 'module_description' => 'Thiết kế quy trình FOH, BOH, toàn quán'],
            ['module_week' => 'Tuần 9',  'module_title' => 'Profit',  'module_description' => 'Các chỉ số tài chính cốt lõi & công thức lợi nhuận'],
            ['module_week' => 'Tuần 10', 'module_title' => 'Tổng kết','module_description' => 'Thuyết trình thành quả và Định hướng bước tới'],
        ],
        'dv2_faqs' => [
...
if ($dv3) {
    clv_set($dv3, [
        ...
        'dv3_pains' => [
            ['pain_number' => '1', 'pain_title' => 'LỢI NHUẬN KHÔNG PHẢN ÁNH ĐÚNG CÔNG SỨC', 'pain_description' => 'Quán đông hơn, doanh thu cao hơn, nhưng tiền thực giữ lại không tương xứng.', 'pain_full_width' => ''],
            ['pain_number' => '2', 'pain_title' => 'VẬN HÀNH PHỤ THUỘC VÀO BẠN', 'pain_description' => 'Bạn rời quán một ngày là mọi thứ chao đảo. Nhân sự chưa đủ vững để tự vận hành.', 'pain_full_width' => ''],
            ['pain_number' => '3', 'pain_title' => 'MUỐN MỞ RỘNG NHƯNG CHƯA ĐỦ TỰ TIN', 'pain_description' => 'Bạn cân nhắc mở thêm chi nhánh hoặc nhân bản mô hình, nhưng lo nền móng chưa đủ chắc.', 'pain_full_width' => ''],
            ['pain_number' => '4', 'pain_title' => 'THIẾU NGƯỜI PHẢN BIỆN CHIẾN LƯỢC', 'pain_description' => 'Bạn không thiếu ý tưởng. Bạn thiếu một người đủ hiểu ngành để soi lại quyết định quan trọng trước khi bạn triển khai.', 'pain_full_width' => ''],
            ['pain_number' => '5', 'pain_title' => 'CÔ ĐƠN Ở VAI TRÒ NGƯỜI CHỦ', 'pain_description' => 'Nhân viên không hiểu áp lực của bạn. Gia đình không hiểu bài toán tài chính của bạn. Bạn đang tự xoay xở một mình.', 'pain_full_width' => '1'],
        ],
        'dv3_targets' => [
            ['target_icon' => '🏪', 'target_title' => 'CHỦ QUÁN ĐANG VẬN HÀNH 6–24 THÁNG',        'target_description' => 'Bạn đã đi qua giai đoạn khởi động, nhưng đang cần tối ưu lợi nhuận và hệ thống hóa vận hành.'],
            ['target_icon' => '🧠', 'target_title' => 'CHỦ QUÁN MUỐN NÂNG CẤP TƯ DUY LÃNH ĐẠO',   'target_description' => 'Bạn không chỉ muốn "chạy quán", mà muốn trở thành người kiến tạo chiến lược dài hạn.'],
            ['target_icon' => '🚀', 'target_title' => 'CHUẨN BỊ MỞ QUÁN VỚI QUY MÔ ĐẦU TƯ LỚN',   'target_description' => 'Bạn muốn giảm thiểu rủi ro bằng một lộ trình cá nhân hóa và sự đồng hành 1:1 ngay từ đầu.'],
            ['target_icon' => '📈', 'target_title' => 'CHỦ QUÁN MUỐN MỞ RỘNG HOẶC NHÂN BẢN',      'target_description' => 'Bạn cần một kế hoạch tăng trưởng rõ ràng thay vì mở thêm theo cảm tính.'],
        ],
        'dv3_not_like' => [
            ['not_text' => 'Giao trình không đại trà'],
            ['not_text' => 'Không nội dung cố định cho tất cả'],
            ['not_text' => 'Không học chung theo lớp'],
        ],
        'dv3_you_get' => [
            ['get_text' => 'Coach là cố vấn chuyên môn cho mô hình của bạn'],
            ['get_text' => 'Tiếp cận toàn bộ tài liệu, form mẫu, hệ thống từ 15 năm kinh nghiệm'],
            ['get_text' => 'Làm việc trực tiếp với coach (email / điện thoại / Zoom hàng tuần)'],
        ],
        'dv3_focus_badges' => [
            ['badge_label' => 'Mô hình kinh doanh của bạn'],
            ['badge_label' => 'Báo cáo tài chính thật'],
            ['badge_label' => 'Menu thật'],
            ['badge_label' => 'Nhân sự thật'],
            ['badge_label' => 'Quyết định chiến lược thật'],
        ],
        'dv3_focus_note' => 'Mục tiêu không phải học thêm kiến thức. Mục tiêu là mô hình của bạn vận hành tốt hơn sau từng tháng.',
        'dv3_values' => [
            ['value_number' => '1', 'value_title' => 'CHIẾN LƯỢC CÁ NHÂN HOÁ TUYỆT ĐỐI',     'value_description' => 'Lộ trình 6 tháng hoặc 12 tháng được thiết kế riêng cho bạn. Ưu tiên đúng việc quan trọng nhất tại từng giai đoạn.'],
            ['value_number' => '2', 'value_title' => 'TƯ DUY LÃNH ĐẠO CẤP ĐỘ NGƯỜI CHỦ',     'value_description' => 'Bạn có người phản biện chiến lược, soi lại quyết định lớn và giúp bạn nhìn xa hơn vận hành hằng ngày.'],
            ['value_number' => '3', 'value_title' => 'HỆ THỐNG VẬN HÀNH TRƯỞNG BỀN VỮNG',    'value_description' => 'Từ cấu trúc chi phí, biên lợi nhuận đến phân quyền nhân sự – mọi thứ được thiết kế để bạn không còn bị cuốn 24/7.'],
        ],
        'dv3_deliverables' => [
            ['deliverable_title' => 'Phân tích sâu',                  'deliverable_description' => 'cấu trúc chi phí & lợi nhuận'],
            ['deliverable_title' => 'Thiết kế roadmap 6–12 tháng',    'deliverable_description' => 'với KPI cụ thể'],
            ['deliverable_title' => 'Tối ưu menu',                    'deliverable_description' => 'và hiệu suất từng nhóm sản phẩm'],
            ['deliverable_title' => 'Thiết lập hệ thống phân quyền',  'deliverable_description' => '& KPI nhân sự'],
            ['deliverable_title' => 'Chuẩn hóa quy trình vận hành',   'deliverable_description' => 'theo thực tế mô hình'],
            ['deliverable_title' => 'Hỗ trợ ra quyết định',           'deliverable_description' => 'mở rộng hoặc tái cấu trúc'],
        ],
        'dv3_deliverables_note' => '* Ngoài buổi coaching hàng tuần, bạn luôn được khuyến khích hỗ trợ trao đổi trực tiếp ngay khi có tình huống quan trọng phát sinh.',
        'dv3_compare_rows' => [
            ['row_label' => 'Thời gian', 'row_btf' => 'Khoá học nhóm 10 tuần', 'row_bm' => 'Chương trình cá nhân 1:1 chuyên sâu'],
            ['row_label' => 'Nội dung',  'row_btf' => 'Đào sâu vào từng chữ P, xây dựng kế hoạch tài chính, thiết kế menu, chọn mặt bằng, xây dựng đội ngũ, thiết lập SOP, nắm vững chỉ số lợi nhuận', 'row_bm' => 'Mọi nội dung được cá nhân hoá theo chính mô hình của bạn'],
            ['row_label' => 'Mục đích',  'row_btf' => 'Giúp bạn xây nền móng vững chắc', 'row_bm' => 'Giúp bạn tối ưu, mở rộng và nâng cấp chiến lược dài hạn'],
        ],
        'dv3_plans' => [
